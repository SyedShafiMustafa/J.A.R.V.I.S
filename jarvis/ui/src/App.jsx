...
export default function App() {
  ...
  const activeStatus = {
    ...
    VERIFYING: { label: 'VERIFYING', detail: 'Verifying result...' },
    FALLBACK: { label: 'FALLBACK', detail: 'Retrying via UI automation...' },
    PACKAGE_SEARCH: { label: 'PACKAGE SEARCH', detail: 'Searching packages...' },
    PACKAGE_INSPECT: { label: 'PACKAGE INSPECT', detail: 'Inspecting installed packages...' },
    PACKAGE_INSTALL: { label: 'PACKAGE INSTALL', detail: 'Installing package...' },
    PACKAGE_UPDATE: { label: 'PACKAGE UPDATE', detail: 'Updating packages...' },
    PACKAGE_UNINSTALL: { label: 'PACKAGE UNINSTALL', detail: 'Removing package...' },
